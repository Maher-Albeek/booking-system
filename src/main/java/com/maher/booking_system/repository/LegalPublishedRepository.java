...
@Repository
public class LegalPublishedRepository extends LegalContentFileRepository {

    public LegalPublishedRepository(
            ObjectMapper objectMapper,
            @Value("${app.storage.directory:data}") String storageDirectory
    ) {
        super(objectMapper, Path.of(storageDirectory), "legal-content-published.json");
    }
}
